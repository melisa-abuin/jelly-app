...
export const Dropdown = () => {
    ...
    const [animationPhase, setAnimationPhase] = useState<'open' | 'closing' | 'closed'>('closed') // Unified state
        ...
        if (menuItem.subItems) {
            if (isMobile) {
                ...
                if (menuItemElement) {
                    ...
                    const flipY = rect.top + window.scrollY + cssTopOffset + menuHeight + margin > viewportBottom
                        ...
                        >
                            ...
                            {subDropdown.isOpen && subDropdown.activeIndex === index && !isMobile && (
                                <div
                                    ...
                                    style={{
                                        top: subDropdown.top,
                                        left: subDropdown.flip ? 'auto' : 0,
                                        right: subDropdown.flip ? 0 : 'auto',
                                    }}
                                    ref={subMenuRef}
                                >
                                    <div className="dropdown-menu">
